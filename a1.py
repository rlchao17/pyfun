...
def get_hours(seconds):
    ...
    The parameter seconds is a number of seconds since midnight.
...
def time_to_utc(utc_offset, time):
    ...
    The first parameter is a UTC offset specifying a time zone and the
    second parameter is a time in that time zone.
...
def time_from_utc(utc_offset, time):
    ...
    The first parameter is a UTC offset specifying a time zone
    and the second parameter is a time in time zone UTC+0. 
